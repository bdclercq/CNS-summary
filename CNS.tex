...
\end{itemize}
 ...
 \begin{itemize}
 	\begin{multicols}{2}
 		...
 		\item It is computationally infeasable, knowing $PU_b$ or $PR_b$, to generate the other key.
 		\item It is computationally infeasable, knowing $PU_b$ and ciphertext $C$, to recover the original message $M$.
